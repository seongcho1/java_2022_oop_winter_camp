...
public class Baloon extends Aircraft implements Flyable {
  ...
  public void updateConditions() {
    ...
    if (weatherString.equalsIgnoreCase(WeatherType.SUN.toString())) {
      ...
      System.out.println(getFullname() + ": Let's enjoy the good weather and take some pics.");
    ...
    //RAIN - Height decreases with 5
      ...
      System.out.println(getFullname() + ": Damn you rain! You messed up my baloon.");
    ...
    //SNOW - Height decreases with 15
      ...
      System.out.println(getFullname() + ": It's snowing. We're gonna crash.");
