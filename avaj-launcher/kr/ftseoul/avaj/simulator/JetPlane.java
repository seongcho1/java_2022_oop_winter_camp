...
public class JetPlane extends Aircraft implements Flyable {
  ...
  public void updateConditions() {
    ...
    if (weatherString.equalsIgnoreCase(WeatherType.SUN.toString())) {
      ...
      System.out.println(getFullname() + ": What a beautiful view! " + coordinates.toString());
    ...
    //RAIN - Latitude increases with 5
      ...
      System.out.println(getFullname() + ": It's raining. Better watch out for lightings. " + coordinates.toString());
    ...
    //SNOW - Height decreases with 7
      ...
      System.out.println(getFullname() + ": OMG! Winter is coming! " + coordinates.toString());
