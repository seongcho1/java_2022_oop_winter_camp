...
public class Helicopter extends Aircraft implements Flyable {
  ...
  public void updateConditions() {
    ...
    if (weatherString.equalsIgnoreCase(WeatherType.SUN.toString())) {
      ...
      System.out.println(getFullname() + ": Nice weather! Let's going up!" + coordinates.toString());
    ...
    //RAIN - Longitude increases with 5
      ...
      System.out.println(getFullname() + ": Damn you rain! Get away from my helicopter. " + coordinates.toString());
    ...
    //SNOW - Height decreases with 12
      ...
      System.out.println(getFullname() + ": My rotor is going to freeze! " + coordinates.toString());
